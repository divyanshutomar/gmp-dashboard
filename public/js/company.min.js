...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListManager = React.createClass({
		...
		checkPagesBound: function checkPagesBound() {
		...
		getDataset: function getDataset(limitVal, skipVal) {
			$.ajax({
				url: this.props.url,
				dataType: 'json',
				data: {
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'div',
					null,
					React.createElement(List, { dataset: this.state.data })
				),
				React.createElement(
					'a',
					{ className: btnPrevClasses, onClick: this.onPagePrev },
					'Previous'
				),
				React.createElement(
					'a',
					{ className: btnNextClasses, onClick: this.onPageNext },
					'Next'
				),
	...
	ReactDOM.render(React.createElement(ListManager, { url: API_end + "Companies" }), document.getElementById('company'));
	...
	var List = React.createClass({
		...
		render: function render() {
			var listRows = this.props.dataset.map(function (data) {
				return React.createElement(ListItem, { dataitem: data, key: data.id });
			});
			return React.createElement(
				'ul',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var CompanyDataBody = __webpack_require__(263);
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('div', { className: 'clear-fix' }),
							React.createElement(CompanyDataBody, { dataitem: this.props.dataitem })
						),
						React.createElement(
							'a',
							{ className: 'waves-effect waves-light btn blue right' },
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'dd',
						null,
						this.props.dataitem.contactNumber
					)
				),
				React.createElement(
					'dl',
				...
				React.createElement(
					...
					React.createElement(
						'dd',
						null,
						this.props.dataitem.contractor
					)
				)
			);
		}
