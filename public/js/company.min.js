...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListManager = React.createClass({
		...
		getCompaniesCount: function getCompaniesCount() {
			$.ajax({
		...
		getCompanies: function getCompanies(limitVal, skipVal) {
			$.ajax({
				url: this.props.url,
				dataType: 'json',
				data: {
	...
	var List = React.createClass({
		...
		render: function render() {
			var companyRows = this.props.data.map(function (company) {
				return React.createElement(ListItem, { data: company, key: company.id });
			});
			return React.createElement(
				'ul',
